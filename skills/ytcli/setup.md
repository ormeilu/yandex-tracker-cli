...
```json
{
  "permissions": {
    "allow": [
      ...
      "Bash(ytcli sprint list:*)",
      "Bash(ytcli sprint get:*)",
    ...
    "ask": [
      ...
      "Bash(ytcli wiki grid-create:*)",
      "Bash(ytcli wiki grid-update:*)",
      "Bash(ytcli wiki grid-delete:*)",
